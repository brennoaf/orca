...
import type { AppearanceApi } from './api/appearance-api'
...
import type {
  DiscordWebFastResponseApi,
  FloatingCommsApi,
  FloatingCommsDockApi,
  SlackFastResponseApi,
  WhatsAppFastResponseApi
...
export type PreloadApi = {
  ...
  whatsappFastResponse: WhatsAppFastResponseApi
  slackFastResponse: SlackFastResponseApi
  discordWebFastResponse: DiscordWebFastResponseApi
  floatingComms: FloatingCommsApi
  floatingCommsDock: FloatingCommsDockApi
