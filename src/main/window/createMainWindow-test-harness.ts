...
export const acquireSandboxPreloadPathMock = vi.fn((_directory: string, name: string) => ({
...
export function sandboxPreloadPathMock() {
  return { acquireSandboxPreloadPath: acquireSandboxPreloadPathMock }
}
